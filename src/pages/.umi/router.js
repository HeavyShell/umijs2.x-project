...
let routes = [
  {
    ...
    "routes": [
      ...
      {
        "component": () => React.createElement(require('E:/work/webRTC/aaa/umijs-project/node_modules/_umi-build-dev@1.8.4@umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: false })
      }
    ]
  },
  {
